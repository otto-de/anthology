...
class CodomainDeduplicationStageTest extends AnyFlatSpec, Matchers, Diagrams:
    ...
    val aggregateIdXA1 = AggregateId("d9708e05-e6a6-4d38-b452-44dd00856374")
    val aggregateIdXA2 = AggregateId("cc5b5bd9-cded-4357-91b2-f8fdd4a3e0c9")
    val aggregateIdXA3 = AggregateId("789023e5-2974-4dc3-877d-9f975305235b")
    val qaidXA1 = QualifiedAggregateId(domainX, aggregateXA, aggregateIdXA1)
    val qaidXA2 = QualifiedAggregateId(domainX, aggregateXA, aggregateIdXA2)
    val qaidXA3 = QualifiedAggregateId(domainX, aggregateXA, aggregateIdXA3)
    ...
    val aggregateXB = AggregateName("B")
    val aggregateIdXB1 = AggregateId("a00e158e-6c15-45f9-8db7-734435dcaf20")
    val aggregateIdXB2 = AggregateId("e1bbd848-da71-4779-a930-e785ff3eb02b")
    val aggregateIdXB3 = AggregateId("a9e872aa-3c13-4942-8f67-7ab5c18e7d01")
    val qaidXB1 = QualifiedAggregateId(domainX, aggregateXB, aggregateIdXB1)
    val qaidXB2 = QualifiedAggregateId(domainX, aggregateXB, aggregateIdXB2)
    val qaidXB3 = QualifiedAggregateId(domainX, aggregateXB, aggregateIdXB3)
    ...
    val aggregateYA = AggregateName("A") // same name as above is intended
    val aggregateIdYA1 = AggregateId("ce02add2-0932-448d-b753-acb3ed116663")
    val aggregateIdYA2 = AggregateId("c433a2d5-ed0c-412b-957b-72f61db9f24d")
    val aggregateIdYA3 = AggregateId("affe28af-8cf3-4e67-be73-0463fcae84b7")
    val qaidYA1 = QualifiedAggregateId(domainY, aggregateYA, aggregateIdYA1)
    val qaidYA2 = QualifiedAggregateId(domainY, aggregateYA, aggregateIdYA2)
    val qaidYA3 = QualifiedAggregateId(domainY, aggregateYA, aggregateIdYA3)
    ...
    val coId01 = AggregateId("c556f4bf-297c-4ded-8310-2dc8ffcab47a")
    val coId02 = AggregateId("77dc2f1c-6c27-4acc-bf0e-bec8e144e188")
    val coId03 = AggregateId("16c2a62a-6bd8-4076-8e43-f1c88f3402ec")
    val coId04 = AggregateId("8ca84c5b-7f37-4207-b0cd-4ffc39f56edf")
    val coId05 = AggregateId("63c57b7f-c46e-43a3-b8f3-e545a91ac4df")
    val coId06 = AggregateId("7d53edad-8cac-43df-84a9-ad30701582cd")
    val coId07 = AggregateId("e7d98ef3-1cf9-40a7-8276-65566de45907")
    val coId08 = AggregateId("fe08907b-386b-4209-ad7e-f38a1d2d4081")
    val coId09 = AggregateId("5e656953-e6dd-446b-8fcd-5ead06560dbe")
    val coId10 = AggregateId("17a12bc5-652f-470f-97a5-f40c1595bc63")
    val coId11 = AggregateId("c1afaca0-c7c5-468f-9f03-e041215008ad")
    val coId12 = AggregateId("5b4aeac4-8593-4bd0-914c-fdcb65211c5f")
    val coId13 = AggregateId("cf1c0ef4-e3b0-43f6-9535-d2448c330660")
    val coId14 = AggregateId("a640019c-5337-4c7f-ad32-c00e24971ee4")
    val coId15 = AggregateId("08404916-0f86-4b76-8da6-cc28722f2c56")
    ...
    "CodomainDeduplicationStageTest" should "do not deduplicate when batch size = 1" in:
        ...
        val src: Flow[(Option[(QualifiedAggregateId, Set[AggregateId])], Passthrough)] =
            Flow.fromValues(
        ...
        // when
        val result: Seq[(Seq[(QualifiedAggregateId, Seq[AggregateId])], Seq[Passthrough])] =
            src
                .deduplicateCodomainAggregates(Some(config))
                .runToList()
